...
\epsffile{#3}\\
\vskip -0.4in
\makebox[0.31\textwidth]{{\scriptsize (d)}}\hfill%
\makebox[0.31\textwidth]{{\scriptsize (e)}}\hfill
\makebox[0.31\textwidth]{{\scriptsize (f)}}%
\smallskip
\end{minipage}}
...
\newcommand{\Multinomial}{{\rm Multinomial}}
\newcommand{\E}{{\rm E}}
